            ...
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex space-x-1">
                ...
                <Link
                  ...
                  data-testid="link-create-ad"
                  className={`px-4 py-2 text-sm font-medium rounded-md ${location === '/advertiser/create-ad'
                    ? 'text-foreground bg-accent/10'
                    : 'text-muted-foreground hover:text-foreground hover:bg-muted'
                    } transition-colors`}
                >
                ...
                <Link
                  ...
                  className={`px-4 py-2 text-sm font-medium rounded-md ${location === '/advertiser/my-ads'
                    ? 'text-foreground bg-accent/10'
                    : 'text-muted-foreground hover:text-foreground hover:bg-muted'
                    } transition-colors`}
                >
